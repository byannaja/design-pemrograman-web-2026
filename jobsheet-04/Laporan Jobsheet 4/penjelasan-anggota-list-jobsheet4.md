# Penjelasan Kode `anggota/list.html` — Daftar Anggota (Jobsheet 4)
...
| `<p>&copy; 2026 SIMPUS-Mini &mdash; Jobsheet 4</p>` | Teks hak cipta, keterangan jobsheet diperbarui menjadi Jobsheet 4 |
| `</footer></body></html>` | Menutup seluruh elemen halaman |

## Perbedaan dengan Versi Sebelumnya (Jobsheet 3)

- Tidak ada perubahan struktur, data, maupun gaya — halaman ini persis sama dengan versi Jobsheet 3
